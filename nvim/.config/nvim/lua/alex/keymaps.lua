...
keymap.set("n", "<Esc><Esc>", "<Esc>:nohlsearch<cr><Esc>", { desc = "Clear highlighted search results" })
keymap.set("n", "<CR>", ":noh<CR><CR>", { desc = "Clear highlighted search results" })
...
-- creating panes
keymap.set("n", "<leader>s", "<Nop>", { desc = "Panes" })   -- Nop keybind added for which-key description
